...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<>
			{!wrapperDisable &&
				<PanelBody title={<span>{__('Layout', 'petar-bjelica-infinum')}</span>} initialOpen={false} icon={icons.wrapper} className='es-panel-title'>
					...
					{wrapperUseShowControl &&
						<IconToggle
							icon={icons.wrapper}
							label={__('Wrapper', 'petar-bjelica-infinum')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<IconToggle
							...
							label={__('Simple wrapper', 'petar-bjelica-infinum')}
							checked={wrapperUseSimple}
							onChange={(value) => setAttributes({ wrapperUseSimple: value })}
							help={__('Provides only basic spacing and background options.', 'petar-bjelica-infinum')}
						/>
					}
					...
					{wrapperUse &&
						<>
							...
							{showWrapperSpacingTop &&
								<Responsive label={<IconLabel icon={icons.spacingTop} label={__('Top spacing', 'petar-bjelica-infinum')} />}>
							...
							{showWrapperSpacingBottom &&
								<Responsive label={<IconLabel icon={icons.spacingBottom} label={__('Bottom spacing', 'petar-bjelica-infinum')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingTopIn &&
								<Responsive label={<IconLabel icon={icons.spacingTopIn} label={__('Top inner spacing', 'petar-bjelica-infinum')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingBottomIn &&
								<Responsive label={<IconLabel icon={icons.spacingBottomIn} label={__('Bottom inner spacing', 'petar-bjelica-infinum')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerTop &&
								<Responsive label={<IconLabel icon={icons.dividerTop} label={__('Top divider', 'petar-bjelica-infinum')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerBottom &&
								<Responsive label={<IconLabel icon={icons.dividerBottom} label={__('Bottom divider', 'petar-bjelica-infinum')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperHide &&
								<Responsive label={<IconLabel icon={icons.hide} label={__('Hide', 'petar-bjelica-infinum')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperBackgroundColor &&
								<ColorPaletteCustom
									label={<IconLabel icon={icons.backgroundTypeAlt} label={__('Background color', 'petar-bjelica-infinum')} />}
							...
							{!wrapperUseSimple &&
								<>
									{showWrapperWidth &&
										<Responsive label={<IconLabel icon={icons.width} label={__('Width', 'petar-bjelica-infinum')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperOffset &&
										<Responsive label={<IconLabel icon={icons.offset} label={__('Offset', 'petar-bjelica-infinum')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperContainerWidth &&
										<Responsive label={<IconLabel icon={icons.containerWidth} label={__('Container width', 'petar-bjelica-infinum')} />}>
											{options.breakpoints.map((item, index) => {
												const point = ucfirst(item);
									...
									{showWrapperGutter &&
										<Responsive label={<IconLabel icon={icons.gutter} label={__('Gutter', 'petar-bjelica-infinum')} />}>
											{options.breakpoints.map((item, index) => {
							...
							{showWrapperAnchorId &&
								<TextControl
									label={<IconLabel icon={icons.anchor} label={__('Block anchor ID', 'petar-bjelica-infinum')} />}
							...
							{showWrapperId &&
								<TextControl
									label={<IconLabel icon={icons.id} label={__('Block unique identifier', 'petar-bjelica-infinum')} />}
									value={wrapperId}
