		...
		<>
			...
			{listsUse &&
				<>
					...
					{showListsSize &&
						<CustomSelect
							label={<IconLabel icon={icons.textSize} label={__('Font size', 'petar-bjelica-infinum')} />}
							value={listsSize}
					...
					{showListsOrdered &&
						<SimpleHorizontalSingleSelect
							label={__('List type', 'petar-bjelica-infinum')}
							value={listsOrdered}
					...
					{showListsColorOnlyMarker &&
						<IconToggle
							...
							label={__('Show color only on list markers', 'petar-bjelica-infinum')}
