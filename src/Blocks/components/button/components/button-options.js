		...
		<>
			...
			{buttonUse &&
				<>
					{showButtonColor &&
						<ColorPaletteCustom
							label={<IconLabel icon={icons.color} label={__('Color', 'petar-bjelica-infinum')} />}
							value={buttonColor}
					...
					{showButtonIsLink &&
						<IconToggle
							icon={icons.link}
							label={__('Display as link', 'petar-bjelica-infinum')}
					...
					{showButtonSize && !buttonIsLink &&
						<SimpleVerticalSingleSelect
							label={<IconLabel icon={icons.size} label={__('Size', 'petar-bjelica-infinum')} />}
							options={sizeOptions}
						/>
					}
					...
					{showButtonWidth && !buttonIsLink &&
						<SimpleVerticalSingleSelect
							label={<IconLabel icon={icons.width} label={__('Width', 'petar-bjelica-infinum')} />}
					...
					{showButtonAriaLabel &&
						<TextControl
							label={<IconLabel icon={icons.infoCircle} label={__('ARIA label', 'petar-bjelica-infinum')} />}
					...
					{showButtonIsAnchor &&
						<IconToggle
							icon={icons.anchor}
							label={__('Anchor', 'petar-bjelica-infinum')}
							checked={buttonIsAnchor}
							onChange={(value) => setAttributes({ [getAttrKey('buttonIsAnchor', attributes, manifest)]: value })}
							help={__('Make sure to set the URL as an ID of the element you want to target, e.g. #my-block.', 'petar-bjelica-infinum')}
						/>
					}

					{showButtonId &&
						<TextControl
							label={<IconLabel icon={icons.id} label={__('Unique identifier', 'petar-bjelica-infinum')} />}
							value={buttonId}
