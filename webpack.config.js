...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'petarbjelica.com', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/petar-bjelica-infinum', // Project path relative to project root.
		},
	};
